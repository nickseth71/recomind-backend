...
Return this exact JSON. For "scoreBreakdown" and "engineCoverage": each field below shows a description of what to score and its valid range in quotes — replace that description with your actual computed INTEGER for that field (e.g. "productClarity": 16), never return the description text itself:
{
  ...
  "trustSignals": ["trust claims present OR needed — specific to this product type"],
  "existingFaqs": ${JSON.stringify(existingFaqs)},
  "faq": [
    {
  ...
  "engineCoverage": {
    "chatgpt": "0-100 — ChatGPT Shopping favors clear structured attributes (material, size, price, specs) and unambiguous category fit. Score LOW if attributes are vague/missing, HIGH if the product data has explicit, structured specs an engine can extract cleanly.",
    "perplexity": "0-100 — Perplexity favors citable trust signals: reviews, certifications, guarantees, third-party validation, specific claims it can quote. Score LOW if trustSignals above is sparse/generic, HIGH if there are multiple specific, citable trust claims.",
    "gemini": "0-100 — Gemini favors comparison-ready content: how this product stacks up against alternatives, differentiators, and structured pros/cons. Score LOW if comparisonOpportunities/differentiators are thin, HIGH if the product's competitive position is clearly articulated.",
    "aiOverview": "0-100 — Google AI Overviews favors FAQ/snippet-style content that directly answers specific questions. Score LOW if existingFaqs/faq above are sparse or don't address real buyer objections, HIGH if there's substantial, specific Q&A content."
  },
  "prioritizedFixes": [
    {
      "priority": 1,
...
Return JSON:
{
  ...
  "rankingFactors": ["what would help this product rank higher"],
  "competitorStrength": "WEAK | MODERATE | STRONG",
